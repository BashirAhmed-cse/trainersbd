...
import { Search, MapPin, Star, ChevronDown, Mail, Users } from 'lucide-react';
          ...
          <div>
            <div className="mb-8">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 pr-4 py-3 border-slate-300 dark:border-slate-700 focus:border-blue-600"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {displayedMembers.map((member) => (
                <Card key={member.id} className="overflow-hidden group hover:shadow-xl transition-all duration-300 border-slate-200 dark:border-slate-700 p-0">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {displayedTrainers.map((trainer) => (
                <Card key={trainer.id} className="overflow-hidden group hover:shadow-xl transition-all duration-300 border-slate-200 dark:border-slate-700 p-0">
                  <div className="relative h-48 bg-slate-200 dark:bg-slate-700 overflow-hidden">
                    <Image
                      ...
                      className="object-cover object-top group-hover:scale-105 transition-transform duration-500"
                      onError={(e) => {
                        e.currentTarget.src = '/placeholder-trainer.jpg';
                      }}
                    />
